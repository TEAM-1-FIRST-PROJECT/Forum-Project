...
return (
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8 box-decoration-slice bg-gradient-to-r from-indigo-600 to-black-500 text-white px-2 rounded-md">
          ...
          <p className="font-light text-white sm:text-xl dark:text-gray-400">Discover responses to frequently asked questions and dive into the sea of intriguing topics within our blog 👌</p>
      </div> 
